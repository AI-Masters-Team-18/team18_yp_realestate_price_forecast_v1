...
# from cianparser.constants import FILE_NAME_NEWOBJECT_FORMAT, MIN_AREA, MAX_AREA
...
class NewObjectListParser:
    ...
    def build_file_path(self):
        ...
        # file_name = FILE_NAME_NEWOBJECT_FORMAT.format(self.accommodation_type, MIN_AREA, MAX_AREA)
    ...
    def parse_list_offers_page(self, html, page_number: int, count_of_pages: int, attempt_number: int):
        ...
        print("12341")
        print("12341")
        offers1 = list_soup.select("div[data-mark='GKCard']")
